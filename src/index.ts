...
app.get("/ping", async (req: Request, res: Response) => {
    try {
        ...
        if (error instanceof Error) {
            ...
            res.send("Erro inesperado")//teste
        }
    }
})
...
app.get("/users", async (req: Request, res: Response) => {
    try {
        ...
        const usersDB = await userData.findUsers(q)
...
app.get("/accounts", async (req: Request, res: Response) => {
    try {
        ...
        const accountData = new AccountDatabase()
        const accountsDB = await accountData.getAccount()
